    ...
    <td style="padding:20px 40px 0;">
      <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td style="padding:10px 0;font-size:15px;font-weight:700;color:#1F6F67;text-align:right;">₦{{ number_format($order->total, 0) }}</td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <td style="padding:24px 40px 0;">
      <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td style="padding:10px 0;border-bottom:1px solid #f0f0ee;font-size:13px;color:#111315;font-weight:500;text-align:right;">₦{{ number_format($item->total_price, 0) }}</td>
        </tr>
        @endforeach
      </table>
    </td>
